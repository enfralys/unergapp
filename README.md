...
### TODOS
- [x] Create endpoint on permissions controller to list all route resource on permissions
- [x] Create endpoint on permissions controller to list all permission prefix
- [x] CRUD permissions
- [x] CRUD role
